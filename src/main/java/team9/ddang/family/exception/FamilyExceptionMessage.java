...
public enum FamilyExceptionMessage {
    ...
    MEMBER_ALREADY_IN_FAMILY("해당 유저는 이미 다른 가족에 속해 있습니다."),
    MEMBER_NOT_IN_FAMILY("해당 유저는 가족에 속해 있지 않습니다."),
    ...
    MEMBER_FAMILY_BOSS("패밀리댕의 주인은 추방될 수 없습니다."),

    // Member
    MEMBER_NOT_FOUND("해당 유저를 찾을 수 없습니다."),
    MEMBER_NOT_FAMILY_BOSS("패밀리댕의 주인이 아닙니다."),
    MEMBER_NOT_EQUAL_FAMILY("다른 패밀리댕에 속한 유저입니다."),
