...
public class WalkLocationServiceImpl implements WalkLocationService {
    ...
    private void findNearbyMember(String email){
        ...
        List<MemberNearbyResponse> memberNearbyResponseList = memberDogRepository.findDogsAndMembersByMemberEmails(memberEmailList);
        messagingTemplate.convertAndSend("/sub/walk/" + email, memberNearbyResponseList);
    }
